    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listanomes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> lista, View item, int position, long id) {
                ...
                Intent intentGotoFormulario = new Intent(MainActivity.this,FormularioActivity.class);
        ...
        novoContato.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentGoToFurmulario = new Intent(MainActivity.this,FormularioActivity.class);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, final ContextMenu.ContextMenuInfo menuInfo) {
        ...
        deletar.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                dao.close();
                carregaLista();
                Toast.makeText(MainActivity.this,"Deletatado o contato " + contato.getNome(), Toast.LENGTH_SHORT).show();
                return false;
            }
        });{
